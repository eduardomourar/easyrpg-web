...
(function() {
    ...
    Window_MenuStatus.prototype.drawItemStatus = function(index) {
        ...
        var lineHeight = this.lineHeight();
        this.drawActorName(actor, x, y + lineHeight * .5, width);
        this.drawActorHp(actor, x, bottom - lineHeight * 3, width);
        this.drawActorTp(actor, x, bottom - lineHeight * 1.5, width);
        this.drawActorIcons(actor, x, bottom - lineHeight * 4.5, width);
    };
