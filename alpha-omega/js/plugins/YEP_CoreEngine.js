...
Window_SkillStatus.prototype.refresh = function() {
    ...
    if (this._actor) {
        ...
        this.drawActorName(this._actor, xpad, y, width);
  this.drawActorIcons(this._actor, xpad, y+35, width);this.drawActorHp(this._actor, xpad, y+75, width);
  this.drawActorTp(this._actor, xpad, y+115, width);}
};
